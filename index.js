...
function extractTextInParentheses(str) {
  ...
  // const extractText = Array.from(matches, (match) => match[1]);
  // return extractText;
}
...
function checkRegexFlags(regex) {
  ...
  return regex.flags.includes("gm");

  // const str = regex.flags;

  // if (str.includes("g") && str.includes("m")) return true;
  // else return false;
}
...
function checkFlags(regex) {
  ...
  // if (regex.global) result.push("global");
  if (regex.ignoreCase) result.push("ignoreCase");
  // if (regex.multiline) result.push("muliline");
  // if (regex.dotAll) result.push("single line");
  // if (regex.sticky) result.push("sticky");
...
function checkRegexMethods(regex) {
  ...
  if (regex.dotAll) result.push("dotAll");
  if (regex.multiline) result.push("muliline");
  if (regex.sticky) result.push("sticky");
